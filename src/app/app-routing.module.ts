...
const routes: Routes = [
  ...
  { path: 'Cadastro-Hotel/:id', component: CadastroHotelParteDoisComponent, data: [{status: true}]},
  { path: 'Editar-Hotel/:id', component: CadastroHotelParteDoisComponent, data: [{status: false}] }
];
